...
>
      ...
      <div className="container grid lg:grid-cols-2 h-[calc(100vh-60px)]">
        ...
        <div className="text-[70px] sm:text-[100px] font-bold leading-tight flex justify-center items-center text-lime-400">
          <div>
            <p data-aos="zoom-in-up">I am</p>
            <p data-aos="zoom-in-up">Noushad</p>
            <p data-aos="zoom-in-up">Akhter</p>
          </div>
        </div>
      </div>
    </div>
