    ...
    <div id="contact" className="pt-32 container">
      <div className="grid md:grid-cols-2 gap-10 md:gap-6">
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-3 text-blue-600 items-center" data-aos="zoom-in-up">
            <AiOutlineMail size={30} /> <a href="mailto:noushadakhter1985@gmail.com">noushadakhter1985@gmail.com</a>
          </div>
          <div className="flex gap-3 text-blue-600 items-center" data-aos="zoom-in-up">
            <BsTelephone size={30} /> <a href="tel:+923453143819">+923453143819</a>
          </div>
        </div>
